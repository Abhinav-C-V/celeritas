"""
Django settings for celeritas project.
...
SECRET_KEY = 'django-insecure-zlu9t8%)@vakg6y#z$o(9=pgoj0_o05acq410t$4h6oknmhlc^'
...
WSGI_APPLICATION = 'celeritas.wsgi.application'
